% 
% Description: This script evaluates the performance of the Discrete Wavelet 
% Transform (DWT) for denoising Extracellular Action Potential recordings
%
...
for i=1:n_folds
    ...
    for iter=1:param_comb_size
        ...
        for l=1:n_channels  
            ...
            filtered_train_signal(:, l) = wden(X, TPTR, SORH, SCAL, N, WNAME);
    ...
    for l=1:n_channels  
        ...
        filtered_test_signal(:, l) = wden(X, TPTR, SORH, SCAL, N, WNAME);
